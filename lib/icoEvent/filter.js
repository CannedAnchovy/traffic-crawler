    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            _context.next = 13;
            return (0, _fsPromise.writeFile)(fileName + '.csv', (0, _csv.icoEventListToCsvString)(icoEventList));
...
function filterIcoEvent(icoEvent) {
  if (icoEvent.status === 'active') return true;else if ((0, _utility.withinDate)(icoEvent.endDate, '2018/08/01')) return true;
  return false;
}
