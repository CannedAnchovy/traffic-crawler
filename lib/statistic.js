      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _context.next = 12;
            return (0, _fsPromise.writeFile)(fileName, (0, _csv.getRankStatisticListCsvString)(statisticRankList));
...
function getRankStatistic(list, rankName) {
  ...
  var num = rankList.length > 10 ? 10 : rankList.length;
  ...
  for (var _i2 = 0; _i2 < rankList.length; _i2++) {
    num = rankList[_i2].eventList.length > 10 ? 10 : rankList[_i2].eventList.length;
